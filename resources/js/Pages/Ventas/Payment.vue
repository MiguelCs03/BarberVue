    ...
    <div class="max-w-4xl mx-auto">
      ...
      <div class="mb-8 text-center">
        ...
        <p class="text-lg" :style="{ color: 'var(--text-secondary)' }">
          Escanea el código QR para confirmar tu venta
        </p>
      </div>
        ...
        <div class="space-y-8">
          ...
          <div class="flex flex-col items-center">
            <div class="mb-6">
              ...
              >
                <img 
                  :src="'data:image/png;base64,' + venta.qrImage" 
            ...
            <div class="w-full max-w-md space-y-4">
              ...
              <div class="p-4 rounded-lg" :style="{ backgroundColor: 'var(--bg-secondary)' }">
                <h3 class="font-bold mb-3 flex items-center gap-2" :style="{ color: 'var(--text-primary)' }">
                  <ShoppingBagIcon class="w-5 h-5" :style="{ color: 'var(--color-primary)' }" />
                  Detalles de la Venta
                </h3>
                <div class="space-y-2 text-sm">
                  <div class="flex justify-between">
                    <span :style="{ color: 'var(--text-secondary)' }">Venta ID:</span>
                    <span class="font-semibold" :style="{ color: 'var(--text-primary)' }">#{{ venta.id }}</span>
                  </div>
                  <div class="flex justify-between">
                    <span :style="{ color: 'var(--text-secondary)' }">Estado:</span>
                    <span class="font-semibold text-amber-500">Pendiente de confirmación</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <!-- Payment Status -->
          <div class="border-t pt-6" :style="{ borderColor: 'var(--bg-primary)' }">
